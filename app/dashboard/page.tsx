                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                      ...
                      {editingItemId === item.id ? (
                        <div className="flex flex-wrap items-center gap-2" onClick={(e) => e.stopPropagation()}>
                          ...
                          <div className="flex gap-2">
                            <button onClick={(e) => handleUpdateTitle(index, e)} className="text-xs bg-emerald-500 hover:bg-emerald-400 text-white px-3 py-2 rounded transition font-medium">Save</button>
                            <button onClick={() => setEditingItemId(null)} className="text-xs bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded transition font-medium">Cancel</button>
                          </div>
                        </div>
                      ) : (
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-4 w-full sm:w-auto mt-2 sm:mt-0 pt-3 sm:pt-0 border-t sm:border-0 border-slate-200 dark:border-white/5">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-blue-600 dark:text-blue-400 font-bold px-3 py-1 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 rounded-lg text-sm transition-colors duration-300">
                          {item.score}/100
                        </span>
